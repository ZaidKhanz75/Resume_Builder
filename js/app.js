...
// supports following number formats - (123) 456-7890, (123)456-7890, 123-456-7890,123.456.7890, 1234567890, +316345897412, 075-635467525
...
// console.log(nameDsp, imageDsp, phonenoDsp, emailDsp, designationDsp, addressDsp, summaryDsp, projectsDsp, achievementsDsp, skillsDsp, educationsDsp, experiencesDsp);


// first value is for attributes and second one passes the nodelists
...
const getUserInputs = () => {
    ...
    console.log(fetchValues(['achieve_title, achieve_description'], achievementsTitleElem, achievementsDescriptionElem))
    ...
    let eduSchoolElem = document.querySelectorAll('.edu_school'),
        ...
        eduGraduationElem = document.querySelectorAll('.edu_graduation_date'),
    ...
    middlenameElem.addEventListener('keyup', (e) => validateFormData(e.target, validType.TEXT, 'Middle Name'));
    lastnameElem.addEventListener('keyup', (e) => validateFormData(e.target, validType.TEXT, 'Middle Name'));
    ...
    eduDescription.forEach(item => item.addEventListener('keyup', (e) => validateFormData(e.target, validType.ANY, 'Description')));
    ...
    return {
        ...
        educations: fetchValues(['edu_school', 'edu_degree', 'edu_city', 'edu_start_date', 'edu_graduation_date', 'edu_description'], eduSchoolElem, eduDegreeElem, eduCityElem, eduStartDateElem, eduGraduationElem, eduDescription),
